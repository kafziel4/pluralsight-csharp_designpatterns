namespace Decorator
{
    ...
    /// ConcreteDecorator1
    /// </summary>
    public class StatiticsDecorator : MailServiceDecoratorBase
    {
        public StatiticsDecorator(IMailService mailService)
            : base(mailService)
        {
        }
        ...
        public override bool SendMail(string message)
        {
            ...
            Console.WriteLine($"Collecting statistics in {nameof(StatiticsDecorator)}.");
